"""
Django settings for smart_search_48397 project.
...
ROOT_URLCONF = 'smart_search_48397.urls'
...
WSGI_APPLICATION = 'smart_search_48397.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Smart Search Support <support@smart-search-48397.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "smart_search_48397 API",
    "DESCRIPTION": "API documentation for smart_search_48397 App",
    "VERSION": "v1",
}
